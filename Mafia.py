...
def login():
    os.system('clear')
    print logo1
    print "\033[1;91m[1]\x1b[1;97mSTART WITH ALI( \033[1;92m NOW)"
    time.sleep(0.05)
...
def Zeek():
    os.system('clear')
    print logo1
    print '\x1b[1;97m[1]  START CLONING With ALi'
    time.sleep(0.10)
    print '\x1b[1;92m[2] ALI FB ACCOUNT'
    time.sleep(0.10)
    ...
    time.sleep(0.10)
    print '\x1b[1;91m[6] ALi FACEBOOK'
    time.sleep(0.10)
